"""
Django settings for Pdetector project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'p-detector-backend-api.onrender.com']

CSRF_TRUSTED_ORIGINS = ['https://p-detector-backend-api.onrender.com']
...
WSGI_APPLICATION = 'Pdetector.wsgi.application'
